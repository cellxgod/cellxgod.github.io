...
const SOCIALS = [
  { name: 'Instagram', icon: InstagramIcon, href: 'https://instagram.com/cellxgod', handle: '@cellxgod' },
  { name: 'GitHub', icon: GithubIcon, href: 'https://github.com/cellxgod', handle: 'cellxgod' },
  { name: 'Spotify', icon: SpotifyIcon, href: 'https://open.spotify.com/user/31duzxe26jysusaouhcwik26hvve?si=d5ZuSm2PTTS2iD4iXI20CA&utm_source=copy-link&sci=spotify%3Acard-config%3A5dbWFVxYCGIlZKdMmZwf4k', handle: 'cellxgod' },
  { name: 'YouTube', icon: YoutubeIcon, href: 'https://www.youtube.com/channel/UCTXBbbD0OpzqaCA3WRJRXQQ', handle: 'YouTube' },
  { name: 'Twitch', icon: TwitchIcon, href: 'https://m.twitch.tv/iamvellex?desktop-redirect=true', handle: 'iamvellex' },
]
      ...
      <div className="glass animate-fade-up animate-glow-pulse w-full max-w-md rounded-3xl p-6 sm:p-8">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="animate-float-slow relative">
            <div className="absolute -inset-1 rounded-full bg-gradient-to-tr from-primary via-accent to-primary opacity-70 blur-md" aria-hidden="true" />
            <Image
          ...
          <h1 className="text-shimmer mt-4 flex items-center gap-2 font-sans text-3xl font-bold tracking-tight">
            CYAN
            <BadgeCheck className="size-6 shrink-0 text-accent" aria-label="verified" />
          </h1>
        ...
        {/* socials */}
        <nav aria-label="Social links" className="mt-7 grid grid-cols-3 gap-3 sm:grid-cols-5">
